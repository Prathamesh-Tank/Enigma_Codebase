...
for(int i=0; i<NUM_CPUS; i++)                                
    ...
    cout<<"LLC_SECURITY_MODE:"<<LLC_SECURITY_MODE<<endl;
...
print_interconnect_stats();
    ...
    for(int x=0; x<NUM_SLICES; x++)
    {
        ...
        cout<<"no_of_sos_triggered: "<<uncore.LLC[x]->no_of_sos_triggered<<endl;
        cout<<"total_miss_at_tag_array: "<<uncore.LLC[x]->total_miss_at_tag_array<<endl;
        cout<<"SoS_percentage: "<<(uncore.LLC[x]->total_miss_at_tag_array ? ((float)uncore.LLC[x]->no_of_sos_triggered/(float)uncore.LLC[x]->total_miss_at_tag_array)*100 : 0.0f)<<endl;
        cout<<"deferred_sos_services: "<<uncore.LLC[x]->deferred_sos_services<<endl;
        cout<<"deferred_sos_dirty_writebacks: "<<uncore.LLC[x]->deferred_sos_dirty_writebacks<<endl;
        cout<<"maya_tag_only_first_touches: "<<uncore.LLC[x]->maya_tag_only_first_touches<<endl;
        cout<<"maya_promotion_hits_to_data_store: "<<uncore.LLC[x]->maya_promotion_hits_to_data_store<<endl;
        cout<<"maya_promotion_rate: "<<(uncore.LLC[x]->maya_tag_only_first_touches ? ((double)uncore.LLC[x]->maya_promotion_hits_to_data_store / (double)uncore.LLC[x]->maya_tag_only_first_touches) : 0.0)<<endl;
        cout<<"ssl_common_path_selections: "<<uncore.LLC[x]->ssl_common_path_selections<<endl;
        cout<<"sos_forced_fill_selections: "<<uncore.LLC[x]->sos_forced_fill_selections<<endl;
    }
