...
/*----------------------------------------CEASER-S----------------------------------------------*/
	...
	uint64_t dead_block=0, total_bfs=0;
        uint64_t total_miss_at_tag_array=0, no_of_sos_triggered=0;
        uint64_t tag_store_full_events=0, deferred_sos_services=0, deferred_sos_dirty_writebacks=0;
        ...
        uint64_t total_rrpv_increment_rounds=0, total_rrpv_eviction_samples=0;
        uint64_t sos_enqueue_events=0, sos_queue_max_occupancy=0;
        uint64_t ssl_common_path_selections=0, sos_forced_fill_selections=0;
        uint64_t stale_tag_repairs=0;
        uint64_t maya_tag_only_first_touches=0, maya_promotion_hits_to_data_store=0;
        uint32_t ssl_pointer=0;
	//BFS
	int marked[2048];
