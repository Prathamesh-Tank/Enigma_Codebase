...
class BLOCK {
  public:
    ...
    uint64_t address,
	     ...
	     ip, //For Hawkeye
	     rrpv_time,
	     ssl; //Added by Prath for proper selection of set selection logic in Data Array
...
class PACKET {
  public:
    ...
    uint32_t pf_metadata, rrpv, da_set; //Data Array set Prath Proposed
    ...
    uint64_t address, 
	     ...
	     //waiting_time_in_queue,
             cycle_enqueued,
	     rrpv_time, //for maintaining access TimneStamps at Data Array for Performance Improvement
	     ssl;
