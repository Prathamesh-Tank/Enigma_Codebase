...
rm inc/cache_mode.h
touch inc/cache_mode.h
echo -e "#ifndef CACHE_MODE_H" >> inc/cache_mode.h
echo -e "#define CACHE_MODE_H" >> inc/cache_mode.h

if [ "${LLC_REPLACEMENT}" == "enigma" ]; then
    CACHE_MODE_LABEL="enigma"
    CACHE_MODE_MIRAGE=1
    CACHE_MODE_SSL_SRRIP=1
    CACHE_MODE_SOS=1
    CACHE_MODE_GLOBAL_RANDOM=0
elif [ "${LLC_REPLACEMENT}" == "mirage" ]; then
    CACHE_MODE_LABEL="mirage"
    CACHE_MODE_MIRAGE=1
    CACHE_MODE_SSL_SRRIP=0
    CACHE_MODE_SOS=0
    CACHE_MODE_GLOBAL_RANDOM=1
elif [ "${LLC_REPLACEMENT}" == "srrip" ]; then
    CACHE_MODE_LABEL="srrip"
    CACHE_MODE_MIRAGE=0
    CACHE_MODE_SSL_SRRIP=0
    CACHE_MODE_SOS=0
    CACHE_MODE_GLOBAL_RANDOM=0
else
    CACHE_MODE_LABEL="generic"
    CACHE_MODE_MIRAGE=0
    CACHE_MODE_SSL_SRRIP=0
    CACHE_MODE_SOS=0
    CACHE_MODE_GLOBAL_RANDOM=0
...
echo -e "#define MIRAGE ${CACHE_MODE_MIRAGE}" >> inc/cache_mode.h
echo -e "#define ENIGMA_ENABLE_SSL_SRRIP ${CACHE_MODE_SSL_SRRIP}" >> inc/cache_mode.h
echo -e "#define ENIGMA_ENABLE_SOS_SUPERVISOR ${CACHE_MODE_SOS}" >> inc/cache_mode.h
echo -e "#define ENIGMA_USE_GLOBAL_RANDOM_DATA ${CACHE_MODE_GLOBAL_RANDOM}" >> inc/cache_mode.h
echo -e "#define LLC_SECURITY_MODE \"${CACHE_MODE_LABEL}\"" >> inc/cache_mode.h
echo -e "#define ENIGMA_SOS_THRESHOLD ${DEFAULT_SOS_THRESHOLD}" >> inc/cache_mode.h
echo -e "#endif" >> inc/cache_mode.h
#########################################################################
...
#define LLC_SECURITY_MODE "enigma"
...
echo "LLC Security Mode: ${CACHE_MODE_LABEL}"
echo "Cores: ${NUM_CORE}"
